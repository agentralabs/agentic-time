...
#[test]
fn test_deadline_add_missing_label() {
...
#[test]
fn test_deadline_add_missing_due_at() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
        json!({"label": "Ship MVP"}),
...
#[test]
fn test_deadline_add_invalid_datetime_format() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_deadline_add_invalid_datetime_partial() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_deadline_add_past_date_succeeds() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_deadline_add_unknown_deadline_type() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_deadline_add_all_four_types() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_deadline_add_invalid_warn_at() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_deadline_complete_malformed_id() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_deadline_complete_nonexistent_id() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_deadline_list_unknown_status_filter() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_list",
...
#[test]
fn test_schedule_create_missing_label() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_schedule_create_missing_start_at() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
...
#[test]
fn test_schedule_create_missing_duration() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
...
#[test]
fn test_schedule_create_zero_duration() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
...
#[test]
fn test_schedule_create_negative_duration() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
...
#[test]
fn test_schedule_create_unknown_priority() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
...
#[test]
fn test_schedule_create_unknown_recurrence_pattern() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
        json!({
...
#[test]
fn test_schedule_reschedule_missing_id() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_schedule_reschedule_nonexistent_id() {
    let (_dir, mut engine) = fresh_engine();
    let fake_uuid = uuid::Uuid::new_v4().to_string();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_reschedule",
...
#[test]
fn test_schedule_range_end_before_start() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_schedule_available_empty_store() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_schedule_conflicts_empty_store() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_sequence_create_missing_label() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_sequence_create_missing_steps() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_sequence_create",
        json!({"label": "Pipeline"}),
...
#[test]
fn test_sequence_create_empty_steps_array() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_sequence_create",
...
#[test]
fn test_sequence_create_step_missing_label() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_sequence_create",
...
#[test]
fn test_sequence_create_single_step() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_sequence_create",
...
#[test]
fn test_sequence_advance_nonexistent_id() {
    let (_dir, mut engine) = fresh_engine();
    let fake_uuid = uuid::Uuid::new_v4().to_string();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_sequence_advance_past_completion() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_sequence_status_nonexistent_id() {
    let (_dir, mut engine) = fresh_engine();
    let fake_uuid = uuid::Uuid::new_v4().to_string();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_decay_create_exponential() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
...
#[test]
fn test_decay_create_half_life() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
...
#[test]
fn test_decay_create_unknown_type() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
...
#[test]
fn test_decay_create_missing_initial_value() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
        json!({"label": "No value"}),
...
#[test]
fn test_decay_create_zero_initial_value() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
...
#[test]
fn test_decay_create_negative_initial_value() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
...
#[test]
fn test_decay_value_nonexistent_id() {
    let (_dir, mut engine) = fresh_engine();
    let fake_uuid = uuid::Uuid::new_v4().to_string();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_value",
...
#[test]
fn test_decay_alert_missing_threshold() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_alert",
...
#[test]
fn test_duration_estimate_missing_label() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_duration_estimate_missing_expected() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_duration_estimate",
        json!({"label": "Task A"}),
...
#[test]
fn test_duration_estimate_zero_minutes() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_duration_estimate",
...
#[test]
fn test_duration_estimate_with_pert_values() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_duration_estimate",
        json!({
...
#[test]
fn test_duration_estimate_confidence_boundary_zero() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_duration_estimate",
...
#[test]
fn test_duration_estimate_confidence_boundary_one() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_duration_estimate",
...
#[test]
fn test_duration_aggregate_empty_ids() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
...
#[test]
fn test_duration_aggregate_invalid_ids() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_duration_aggregate",
...
fn test_empty_string_tool_name() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call("", json!({}), &mut engine);
    assert!(result.is_err());
    assert!(result.unwrap_err().contains("Unknown tool"));
}
...
#[test]
fn test_deadline_add_unicode_label() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_schedule_create_unicode_label() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
        json!({
...
#[test]
fn test_sequence_create_special_chars_in_steps() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_sequence_create",
        json!({
...
#[test]
fn test_rapid_fire_100_stats_calls() {
    let (_dir, mut engine) = fresh_engine();
    for i in 0..100 {
        let result =
...
#[test]
fn test_rapid_fire_50_deadline_add_then_list() {
    let (_dir, mut engine) = fresh_engine();
    for i in 0..50 {
...
#[test]
fn test_rapid_fire_mixed_entity_creation() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_workflow_deadline_full_lifecycle() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_workflow_schedule_create_and_reschedule() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_workflow_sequence_full_completion() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_deadline_add_with_tags() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_deadline_add_with_empty_tags() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_deadline_add_label_is_number_fails() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_deadline_add_due_at_is_number_fails() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_schedule_create_all_priorities() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_schedule_create_with_daily_recurrence() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
        json!({
...
#[test]
fn test_schedule_create_with_weekly_recurrence() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
        json!({
...
#[test]
fn test_schedule_create_with_monthly_recurrence() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
        json!({
...
#[test]
fn test_schedule_range_missing_start() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_range",
        json!({"end": future_dt()}),
...
#[test]
fn test_schedule_range_missing_end() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_range",
...
#[test]
fn test_schedule_conflicts_missing_duration() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_conflicts",
...
#[test]
fn test_decay_alert_missing_within_hours() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_alert",
        json!({"threshold": 50.0}),
...
#[test]
fn test_decay_alert_empty_store() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_alert",
...
#[test]
fn test_decay_value_missing_id() {
    let (_dir, mut engine) = fresh_engine();
    let result =
        agentic_time_mcp::tools::handle_tool_call("time_decay_value", json!({}), &mut engine);
    assert!(result.is_err());
    assert!(result.unwrap_err().contains("id"));
}

#[test]
fn test_decay_value_malformed_id() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_value",
...
#[test]
fn test_duration_aggregate_missing_ids() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_duration_aggregate",
        json!({}),
...
#[test]
fn test_duration_aggregate_two_estimates() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_deadline_list_with_due_within_filter() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_schedule_create_flexible_false() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_create",
        json!({
...
#[test]
fn test_deadline_add_consequence_empty_string() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_add",
...
#[test]
fn test_sequence_create_with_depends_on() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_sequence_create",
        json!({
...
#[test]
fn test_sequence_create_with_duration_on_steps() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_sequence_create",
        json!({
...
#[test]
fn test_decay_create_with_floor() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
...
#[test]
fn test_decay_create_with_tags() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
...
#[test]
fn test_decay_value_after_creation() {
    let (_dir, mut engine) = fresh_engine();
    let create_result = agentic_time_mcp::tools::handle_tool_call(
        "time_decay_create",
...
#[test]
fn test_refresh_after_adding_entities() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_schedule_reschedule_missing_new_start_at() {
    let (_dir, mut engine) = fresh_engine();
    let fake_uuid = uuid::Uuid::new_v4().to_string();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_reschedule",
...
#[test]
fn test_deadline_add_with_valid_warn_at() {
    let (_dir, mut engine) = fresh_engine();
    let due = chrono::Utc::now()
        .checked_add_signed(chrono::Duration::days(7))
        .unwrap()
...
#[test]
fn test_duration_estimate_negative_expected() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_duration_estimate",
...
#[test]
fn test_duration_estimate_defaults_for_pert() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_deadline_complete_id_is_null() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_complete",
        json!({"id": null}),
...
#[test]
fn test_sequence_advance_id_is_empty_string() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_sequence_advance",
        json!({"id": ""}),
...
#[test]
fn test_schedule_available_zero_min_duration() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_available",
...
#[test]
fn test_schedule_range_empty_store() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_schedule_range",
        json!({"start": near_future_dt(), "end": far_future_dt()}),
...
#[test]
fn test_deadline_list_status_pending_empty() {
    let (_dir, mut engine) = fresh_engine();
    let result = agentic_time_mcp::tools::handle_tool_call(
        "time_deadline_list",
        json!({"status": "pending"}),
...
#[test]
fn test_memory_deadline_microsecond_precision() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_memory_decay_staleness_half_life() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_memory_stats_after_entities() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_memory_sequence_session_workflow() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_memory_duration_consolidation() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_identity_deadline_trust_grant_expiry() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_identity_decay_competence_freshness_exponential() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_identity_sequence_workflow() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_identity_schedule_heartbeat_daily() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_identity_duration_receipt_verification() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_vision_deadline_capture_expiry_7_day() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_vision_decay_visual_similarity_linear() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_vision_sequence_capture_compare_diff_report() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_vision_schedule_periodic_screenshot() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_vision_duration_ocr_processing() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_codebase_deadline_code_review_with_warn_at() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_codebase_decay_symbol_relevance_half_life() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_codebase_sequence_parse_index_query_impact() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_codebase_schedule_incremental_reindex() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_codebase_duration_graph_traversal() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_multi_deadline_plus_schedule_same_event() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_multi_sequence_plus_multiple_deadlines() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_multi_one_of_each_entity_type() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_multi_refresh_after_mixed_creation() {
    let (_dir, mut engine) = fresh_engine();
...
#[test]
fn test_multi_10_mixed_entities_stats_consistency() {
    let (_dir, mut engine) = fresh_engine();
